...
interface NichePromoTemplateProps {
  nicheId: string;
...
export default function NichePromoTemplate({
  nicheId,
  heroHeadline,
  heroSubheadline,
  painPointsTitle,
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      message: `[LEAD: ${nicheId}] สนใจแพ็กเกจ: ${formData.get("budget")}`,
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl shadow-primary-500/10 border border-slate-100 max-w-xl mx-auto mb-8 animate-fade-in-up animation-delay-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a 
                ...
                className="flex-1 py-4 text-center bg-white text-slate-700 font-bold rounded-xl border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all text-lg inline-block"
              >
                ดูผลงานก่อน
              </a>
            </div>
